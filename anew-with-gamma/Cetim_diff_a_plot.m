...
WF=8e7;            %dissipated energy to failure per unit volume
n0=1;                   %number of initial local defects
%---------------------Verified parameters in random loading case-----------------------------
lam=0;             %hydrostatic pressure sensitivity
a=0.8;                  %sensitivity of sequence effect
...
%% 
hold on;
Damage1=plot ((1:n),D(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', '^', 'MarkerSize', 10, ...
    'MarkerEdgeColor',  'r', 'MarkerFaceColor' ,'none');
alp1=plot ((1:n),alp(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', '^', 'MarkerSize', 10, ...
...
hold on;
Damage2=plot ((1:n),D(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', 'o', 'MarkerSize', 10, ...
    'MarkerEdgeColor',  'b', 'MarkerFaceColor' ,'none');
alp2=plot ((1:n),alp(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', 'o', 'MarkerSize', 10, ...
...
grid minor;
set(gca ,'FontSize',35);
hXLabel = xlabel('Number of points');
 hTitle =title('Damage and \alpha evolution at constant ratio of a/W_F' ,'Fontsize' ,45);
 hYLabel =ylabel('D');
 % Adjust font
...
hLegend=legend([alp1,Damage1,alp2,Damage2],'\alpha evolution with a=0.8',...
    'D evolution with a=0.8','\alpha evolution with a=0.3','D evolution with a=0.3');
...
saveas(gcf,'F:\Git\Anew\figures\Adamage_compare_a.png');
%% 
