...
repetition=xlsread('F:\Git\MATLAB\anew\tuning.xlsx',1,'G14');
nbrep=xlsread('F:\Git\MATLAB\anew\tuning.xlsx',1,'F14');
copy=nbrep+300;
...
% hTitle =title('Stress evlolution of EP\_12 random load' ,'Fontsize' ,25);
...
% saveas(gcf,'F:\Git\Anew\figures\ep_12_stress.png');
...
% set(gca ,'FontSize',25);
% hXLabel = xlabel('t(s)' ,'Fontsize' ,25);
% hTitle =title('Damage evolution of EP\_12 random load' ,'Fontsize' ,25);
...
% set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
% set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
% saveas(gcf,'F:\Git\Anew\figures\ep_12_damage.png');
% 
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',a,1,'C14');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D14');
% xlswrite('/home/ma/MATLAB/tuning.xlsx',n0,1,'C14');
% xlswrite('/home/ma/MATLAB/tuning.xlsx',n0,1,'D14');
