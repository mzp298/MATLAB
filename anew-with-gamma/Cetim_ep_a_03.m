...
fid = fopen('F:\Git\Cetim\ep_a_03\Acqui_CV.txt');
...
% saveas(gcf,'F:\Git\Anew\figures\ep_03_stress.png');
% 
...
% set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
% set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
% saveas(gcf,'F:\Git\Anew\figures\ep_03_damage.png');

xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',a,1,'C4');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D4');
