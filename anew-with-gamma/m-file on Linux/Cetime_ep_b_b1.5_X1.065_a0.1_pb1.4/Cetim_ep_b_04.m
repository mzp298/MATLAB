...
% fid = fopen('F:\Git\Cetim\ep_b_04\Acqui_CV_1.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_b_04/Acqui_CV_1.txt');
[force]=textscan(fid,'%*s%*s%s%*s%*s','headerlines',5);
area=2.96*10*1e-6; %meter square
stress11=0.9*1000*str2double(strrep(force{1,1},',','.')).*area^-1; %Pa
repetition=xlsread('alpha_varying.xlsx',1,'G5');
nbrep=xlsread('alpha_varying.xlsx',1,'F5');
copy=nbrep+700;
...
xlwrite('alpha_varying.xlsx',max(stress11),1,'C5');
xlwrite('alpha_varying.xlsx',n,1,'D5');
p70=length(find(stress11(1:repetition)>70e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p70,1,'B6');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p90,1,'C6');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p110,1,'D6');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p130,1,'E6');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p150,1,'F6');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p170,1,'G6');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p190,1,'H6');