...
% fid = fopen('F:\Git\Cetim\ep_b_12\Acqui_CV.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_b_12/Acqui_CV.txt');
[force]=textscan(fid,'%*s%*s%s%*s%*s','headerlines',5);
area=2.9*9.95*1e-6; %meter square
stress11=1000*str2double(strrep(force{1,1},',','.')).*area^-1; %Pa
repetition=xlsread('alpha_varying.xlsx',1,'G13');
nbrep=xlsread('alpha_varying.xlsx',1,'F13');
copy=nbrep+700;
...
xlwrite('alpha_varying.xlsx',max(stress11),1,'C14');
xlwrite('alpha_varying.xlsx',n,1,'D14');
p70=length(find(stress11(1:repetition)>70e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p70,1,'B14');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p90,1,'C14');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p110,1,'D14');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p130,1,'E14');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p150,1,'F14');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p170,1,'G14');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p190,1,'H14');