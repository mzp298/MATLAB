...
% fid = fopen('F:\Git\Cetim\ep_b_02\Acqui_CV.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_b_02/Acqui_CV.txt');
[force]=textscan(fid,'%*s%*s%s%*s%*s','headerlines',5);
area=2.98*10*1e-6; %meter square
stress11=0.8*1000*str2double(strrep(force{1,1},',','.')).*area^-1; %Pa
repetition=xlsread('alpha_varying.xlsx',1,'G3');
nbrep=xlsread('alpha_varying.xlsx',1,'F3');
copy=nbrep+700;
...
WF=4e9;            %dissipated energy to failure per unit volume
...
xlwrite('alpha_varying.xlsx',max(stress11),1,'C3');
xlwrite('alpha_varying.xlsx',n,1,'D3');
p70=length(find(stress11(1:repetition)>70e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p70,1,'B4');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p90,1,'C4');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p110,1,'D4');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p130,1,'E4');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p150,1,'F4');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p170,1,'G4');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p190,1,'H4');

mail2me('mzp298@gmail.com','Job done','Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4','/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/alpha_varying.xlsx');
