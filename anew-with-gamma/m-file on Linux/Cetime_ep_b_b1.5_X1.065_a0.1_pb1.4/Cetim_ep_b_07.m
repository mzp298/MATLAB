...
% fid = fopen('F:\Git\Cetim\ep_b_07\Acqui_CV.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_b_07/Acqui_CV.txt');
...
repetition=xlsread('alpha_varying.xlsx',1,'G8');
nbrep=xlsread('alpha_varying.xlsx',1,'F8');
copy=nbrep+700;
...
xlwrite('alpha_varying.xlsx',max(stress11),1,'C8');
xlwrite('alpha_varying.xlsx',n,1,'D8');
p70=length(find(stress11(1:repetition)>70e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p70,1,'B9');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p90,1,'C9');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p110,1,'D9');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p130,1,'E9');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p150,1,'F9');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p170,1,'G9');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/Cetime_ep_b_b1.5_X1.065_a0.1_pb1.4/greater_stress_proportion.xlsx',p190,1,'H9');