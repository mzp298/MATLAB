...
% fid = fopen('F:\Git\Cetim\ep_a_12\Acqui_CV.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_a_12/Acqui_CV.txt');
...
repetition=xlsread('alpha_varying.xlsx',1,'G14');
nbrep=xlsread('alpha_varying.xlsx',1,'F14');
copy=nbrep+700;
...
WF=4.13e9;            %dissipated energy to failure per unit volume
X=1.13;                 %Major damage threshold (meaning S_{max} must be greater than X/2*yield to activate magnification)
...
mail2me('mzp298@gmail.com','Job done','Cetime_ep_a_evolving_b1.5_X1.13_a0.1_pb1/alpha_varying.xlsx','/home/ma/Cetime_ep_a_evolving_b1.5_X1.13_a0.1_pb1/alpha_varying.xlsx');
