...
WF=4.92e9;            %dissipated energy to failure per unit volume
X=1;                 %Major damage threshold (meaning S_{max} must be greater than X/2*yield to activate magnification)
pb=1.1;                %Major damage power
...
mail2me('mzp298@gmail.com','Job done','Cetime_ep_a_evolving_b1.5_X1_a0.1_pb1.1','/home/ma/Cetime_ep_a_evolving_b1.5_X1_a0.1_pb1.1/alpha_varying.xlsx');
