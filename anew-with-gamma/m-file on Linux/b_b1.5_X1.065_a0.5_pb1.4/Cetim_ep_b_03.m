...
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p70,1,'B5');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p90,1,'C5');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p110,1,'D5');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p130,1,'E5');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p150,1,'F5');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p170,1,'G5');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/b_b1.5_X1.065_a0.5_pb1.4/greater_stress_proportion.xlsx',p190,1,'H5');
