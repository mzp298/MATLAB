...
WF=2e8;            %dissipated energy to failure per unit volume
...
hLegend=legend([Damage2,Damage3],'D accumulation with g','D accumulation with D','Location','Best');
...
saveas(gcf,'F:\Git\Anew\figures\Adamage_compare_g_D_fix_alp.png');
