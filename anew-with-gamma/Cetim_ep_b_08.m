...
n0=0.38;                %number of initial local defects
...
% hTitle =title('Stress evlolution of EP\_b\_08 random load' ,'Fontsize' ,25);
...
% saveas(gcf,'F:\Git\Anew\figures\ep_b_08_stress.png');
...
% set(gca ,'FontSize',25);
% hXLabel = xlabel('t(s)' ,'Fontsize' ,25);
% hTitle =title('Damage evolution of EP\_b\_08 random load' ,'Fontsize' ,25);
...
% set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
% set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
% saveas(gcf,'F:\Git\Anew\figures\ep_b_08_damage.png');

xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',length(stress11)/copy,1,'B35');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n0,1,'C35');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D35');
