...
G2=plot ((1:n),G(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', '^', 'MarkerSize', 10, ...
    'MarkerEdgeColor',  'r' , 'MarkerFaceColor' ,'m');
axis([0 n 0 1]);
% %% 
% G2=plot ((1:n),G(1:n),'LineStyle', 'none','LineWidth', 2, 'Marker', '^', 'MarkerSize', 10, ...
%     'MarkerEdgeColor',  'r' , 'MarkerFaceColor' ,'none');
...
hXLabel = xlabel('Number of points' ,'Fontsize' ,35);
 hTitle =title('Damage evolution at random stress history' ,'Fontsize' ,35);
...
hLegend=legend([G2,Damage2,Damage3],'g evolution','D accumulation with g','D accumulation with D','Location','Best');
...
saveas(gcf,'F:\Git\Anew\figures\Adamage_compare_g_D_change_alp.png');
