...
WF=6.975e9;            %dissipated energy to failure per unit volume
...
siglim=0.5*y;          %fatigue limit leading to cycles to failure=2e6(n=4e6)
...
stress11(n)=siglim*sin(n/2*pi);
stress12(n)=111.8*sin((n+1)/2*pi);
...
while D<1
    ...
    stress11(n+1)=siglim*sin((n+1)/2*pi);
    stress12(n+1)=111.8*sin((n+2)/2*pi);
...
xlwrite('Clement_ER7.xlsx',n,1,'D9');
mail2me('mzp298@gmail.com','Job done','Torsion_tension_ER7_sig_tau1118','/home/ma/Torsion_tension_ER7/Clement_ER7.xlsx');
