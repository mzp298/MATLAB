...
stress11(n)=0.9*siglim*sin(n/2*pi);
stress12(n)=125.7*sin((n+1)/2*pi);
...
while D<1
    ...
    stress11(n+1)=0.9*siglim*sin((n+1)/2*pi);
    stress12(n+1)=125.7*sin((n+2)/2*pi);
...
xlwrite('Clement_ER7.xlsx',n,1,'D10');
