...
stress11(n)=1.06*siglim*sin(n/2*pi);
stress12(n)=148.67*sin((n+1)/2*pi);
...
while D<1
    ...
    stress11(n+1)=1.06*siglim*sin((n+1)/2*pi);
    stress12(n+1)=148.67*sin((n+2)/2*pi);
...
xlwrite('Clement_ER7.xlsx',n,1,'D11');
