...
load1=7e8;            %cyclic load
load2=3e8;            %cyclic load
...
% 		palpha1=plot (n+1,alp,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 11, ...
%             'MarkerEdgeColor','none', 'MarkerFaceColor',[238 18 137]/255);	
...
%             'MarkerEdgeColor','g', 'MarkerFaceColor','g');
       Smax2=plot (n+1,sign(sind((n+1)*360/stepnumber))*Smax(n+1),'LineStyle', 'none','LineWidth', 1,'Marker', 's', 'MarkerSize', 11, ...
           'MarkerEdgeColor','none', 'MarkerFaceColor','c');
% palpha2=plot (n+1,alp,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 11, ...
%             'MarkerEdgeColor','none', 'MarkerFaceColor','c');
%         yield8=plot (n+1,yield*s(40).^-1,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 8, ...
%             'MarkerEdgeColor', 'none', 'MarkerFaceColor', 'b');
%                 yield8n=plot (n+1,-yield*s(40).^-1,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 8, ...
...
% 
% %---------------------In loop stress plot settings-----------------------------
grid on;
grid minor;
set(gca ,'FontSize',35);
hXLabel = xlabel('Time step(1/200 s)' ,'Fontsize' ,35);
hYLabel = ylabel('Stress(Pa)', 'Fontsize' ,35);
hTitle = title('S_{max} evolution in High-Low sequence' ,'Fontsize' ,35);
...
% 
% % %---------------------In loop alpha plot settings-----------------------------
% grid on;
% grid minor;
% set(gca ,'FontSize',35);
% hXLabel = xlabel('Time step(1/200 s)' ,'Fontsize' ,35);
% hYLabel = ylabel('\alpha', 'Fontsize' ,35);
% hTitle = title('\alpha evolution in High-Low sequence' ,'Fontsize' ,35);
% set(hTitle, 'FontSize', 35, 'FontWeight' , 'bold')
% hLegend=legend([palpha1,palpha2],'\alpha_1 with high load','\alpha_2 with low load','Location','Best');
% set([hLegend, gca], 'FontSize', 25)
% set(hLegend,'Box','on');
% set(hLegend,'EdgeColor',[1 1 1]); %set the edge colour of the legend to white 
% % Adjust font
...
grid minor;
set(gca ,'FontSize',35);
hTitle = title('Damage evolution in High-Low sequence' ,'Fontsize' ,35);
...
% saveas(gcf,'F:\Git\Anew\figures\high-low-alp.png');
figure(1);
saveas(gcf,'F:\Git\Anew\figures\high-low-Smax.png');
figure(2);
saveas(gcf,'F:\Git\Anew\figures\high-low-D.png');
