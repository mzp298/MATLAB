...
hLegend=legend([err_bt],...
    'Bending-torsion 90 degree out-of-phase test on SM45C(R=-1)','location','bestoutside');
set(hLegend, 'FontSize', 18);
set(hLegend,'Box','on');
set(hLegend,'EdgeColor',[1 1 1]); %set the edge colour of the legend to white 
% Adjust font
...
set(gcf, 'PaperPosition', [0 0 1800 1000]); %set(gcf,'PaperPosition',[left,bottom,width,height])
figure(1);
saveas(gcf,'F:\Git\Anew\figures\bt2D_SM45C_sn.png');
figure(2);
saveas(gcf,'F:\Git\Anew\figures\bt2D_SM45C_err1.png');
