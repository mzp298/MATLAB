...
hLegend=legend([palpha1,palpha2],'(1-\alpha_1) with high load','(1-\alpha_2) with low load','Location','Best');
...
saveas(gcf,'F:\Git\PhDreport\BEAMER\UTC2017\figures\high-low-alp.png');
