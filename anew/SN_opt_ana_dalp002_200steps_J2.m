...
delta_alp=0.02;       %optimal alpha filter threshold
cycles=2;          %numerical cycles to adaptation
m=0;                   % mean stress
load = [y/1.2 y/1.3 y/1.4 y/1.55 y/1.6 y/1.7 y/2 y/2.5 y/3 y/3.5 y/4 y/4.5 y/5 y/5.5 y/6];
...
% save('SN_opt_ana_2000_001.mat','load','NF_num','NF_direct','NF_num_opt','error','y')
% %% 
% %-------------plot-----------------------------
% clear;load('SN_opt_ana_2000_001.mat');
figure(1)
...
figure(1)
saveas(gcf,'F:\Git\Anew\figures\SN_opt_ana_200_delta_alp=0.02.png');
figure(2)
saveas(gcf,'F:\Git\Anew\figures\SN_opt_ana_200_delta_alp=0.02_err.png');
