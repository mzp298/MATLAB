...
repetition=xlsread('F:\Git\MATLAB\anew\tuning.xlsx',1,'G5');
nbrep=xlsread('F:\Git\MATLAB\anew\tuning.xlsx',1,'F5');
copy=nbrep+300;
...
% hTitle =title('Stress evlolution of EP\_04\_1 random load' ,'Fontsize' ,25);
...
% saveas(gcf,'F:\Git\Anew\figures\ep_04_1_stress.png');
% 
...
% set(gca ,'FontSize',25);
% hXLabel = xlabel('t(s)' ,'Fontsize' ,25);
% hTitle =title('Damage evolution of EP\_04\_1 random load' ,'Fontsize' ,25);
...
% set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
% set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
% saveas(gcf,'F:\Git\Anew\figures\ep_04_1_damage.png');

xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',a,1,'C5');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D5');
