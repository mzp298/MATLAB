...
load1=3e8;            %cyclic load
load2=7e8;            %cyclic load
...
%             'MarkerEdgeColor','g', 'MarkerFaceColor','g');
 		palpha1=plot (n+1,1-alp,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 11, ...
             'MarkerEdgeColor','none', 'MarkerFaceColor','c');	
...
%         Sb1=plot (n+1,sign(Sb11(33))*normSb(33),'LineStyle', 'none','LineWidth', 1,'Marker', 'v', 'MarkerSize', 10, ...
%             'MarkerEdgeColor','g', 'MarkerFaceColor','g');
 palpha2=plot (n+1,1-alp,'LineStyle', 'none','LineWidth', 1,'Marker', 'o', 'MarkerSize', 11, ...
...
hYLabel = ylabel('1-\alpha', 'Fontsize' ,35);
hTitle = title('(1-\alpha) evolution in High-Low sequence' ,'Fontsize' ,35);
set(hTitle, 'FontSize', 35, 'FontWeight' , 'bold')
hLegend=legend([palpha1,palpha2],'(1-\alpha_1) with low load','(1-\alpha_2) with high load','Location','Best');
...
saveas(gcf,'F:\Git\Anew\figures\low-high-alp.png');
saveas(gcf,'F:\Git\PhDreport\BEAMER\UTC2017\figures\low-high-alp.png');
