...
sig_xx_original=f_sig_xx(25)*force{1,1}*1e6;%Pa
tau_xy_original=f_tau_xy(25)*force{1,1}*1e6; %Pa
...
nF_num=(e-1)/ari;
nF_exp=T_exp(25)/184.32*repetition;
error=(nF_num-nF_exp)/nF_exp
xlwrite('HNAP_random.xls',nF_num,1,'G26');
xlwrite('HNAP_random.xls',error,1,'H26');
