...
[time,cycles,force,forcecommande,displacement]=textread('F:\Git\Cetim\ep_a_04\Acqui_CV_2.txt','%s%s%s%s%s','headerlines',5);
...
saveas(gcf,'F:\Git\Anew\figures\ep04_2_stress.png');
...
set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
 saveas(gcf,'F:\Git\Anew\figures\ep04_2_damage.png');
