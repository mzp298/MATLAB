...
fid = fopen('F:\Git\Cetim\ep_b_04\Acqui_CV_2.txt');
...
n0=9;                     %number of initial local defects
...
hTitle =title('Stress evlolution of EP\_b\_04\_2 random load' ,'Fontsize' ,25);
...
saveas(gcf,'F:\Git\Anew\figures\ep_b_04_2stress.png');
...
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',length(stress11)/copy,1,'B31');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n0,1,'C31');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D31');
