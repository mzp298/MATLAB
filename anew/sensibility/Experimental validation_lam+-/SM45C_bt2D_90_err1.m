...
%-------------------------------------------------bending--------------------------------
load('SM45C.mat','lam','W0','b','a','E','k','nu','y','stepnumber','cycles','delta_alp','cycles90'); %final fitting
load('gaussian.mat');
...
hold on;
MatlabFit_bt2d90=plot(NF_num,Smax_bt2d90,'-m','MarkerSize',12,'LineWidth', 3);
xlabel NF;
ylabel Smax;
...
hLegend=legend(err_bt_m,...
    ['Bending-torsion 90 degree ',sprintf('\n'),'out-of-phase test on SM45C'],'location','northwest');
set(hLegend, 'FontSize', 28);
set(hLegend,'Box','on');
set(hLegend,'EdgeColor',[1 1 1]); %set the edge colour of the legend to white
% Adjust font
