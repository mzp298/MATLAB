...
b=b_test(p);
save('AL6082T6.mat','W0','b','a','E','k','nu','y','stepnumber','cycles','delta_alp');
run('AL6082T6_bt1D_new_alp.m'); %--to get new alp(p) using b_test(p)---
...
save('AL6082T6.mat','W0','b','NFben_num','NFtor_num','alp_ben','alp_tor','a','E','k','nu','y','stepnumber','cycles','delta_alp','cycles90'); %save the best fit W0, b, alp_ben, alp_tor