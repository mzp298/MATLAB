...
save('SN_num_ana_100steps_J2.mat','y','load','NF_num','NF_direct','error');
...
%----------ploting--------------------
clear;clc;close all;
load('SN_num_ana_100steps_J2.mat');
figure(1)
...
figure(1)
saveas(gcf,'F:\Git\Anew\figures\SN_num_ana_stepnumber=100.png');
figure(2)
saveas(gcf,'F:\Git\Anew\figures\SN_num_ana_stepnumber=100_err.png');
