...
delta_alp=1e-5;       %optimal alpha filter threshold
...
save('SN_opt_ana_dalp000001_200steps_J2.mat','y','load','NF_num_opt','NF_direct','error');
%% 
...
%-------------plot-----------------------------
clear;clc;close all;
load('SN_opt_ana_dalp000001_200steps_J2.mat');
figure(1)
...
figure(1)
saveas(gcf,'F:\Git\Anew\figures\SN_opt_ana_200_delta_alp=0.00001.png');
figure(2)
saveas(gcf,'F:\Git\Anew\figures\SN_opt_ana_200_delta_alp=0.00001_err.png');
