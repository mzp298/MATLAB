...
W0=3.27e6;            %dissipated energy to failure per unit volume
...
%---------------------Verified parameters in constant loading case-----------------------------
stepnumber=30;        %devide one cycle in 200 parts
delta_alp=0.001;       %optimal alpha filter threshold
...
save('SN_num_ana_30steps_J2.mat','y','load','NF_num','NF_direct','error');
...
%----------ploting--------------------
clear;clc;close all;
load('SN_num_ana_30steps_J2.mat');
figure(1)
...
figure(1)
saveas(gcf,'F:\Git\Anew\figures\SN_num_ana_stepnumber=30.png');
figure(2)
saveas(gcf,'F:\Git\Anew\figures\SN_num_ana_stepnumber=30_err.png');
