...
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p70,1,'B8');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p90,1,'C8');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p110,1,'D8');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p130,1,'E8');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p150,1,'F8');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p170,1,'G8');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p190,1,'H8');