...
W0=3.846e8;            %dissipated energy to failure per unit volume
...
lam=0.4;               %hydrostatic pressure sensitivity
...
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p70,1,'B4');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p90,1,'C4');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p110,1,'D4');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p130,1,'E4');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p150,1,'F4');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p170,1,'G4');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.4/greater_stress_proportion.xlsx',p190,1,'H4');

mail2me('mzp298@gmail.com','Job done','b_b1.1_a0.1_lam0.4','/home/ma/b_b1.1_a0.1_lam0.4/alpha_varying.xlsx');
