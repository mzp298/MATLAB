...
% fid = fopen('F:\Git\Cetim\ep_b_01\Acqui_CV.txt');
fid = fopen('/home/ma/MATLAB/Cetim/ep_b_01/Acqui_CV.txt');
[force]=textscan(fid,'%*s%*s%s%*s%*s','headerlines',5);
area=2.89*9.95*1e-6; %meter square
stress11=1000*str2double(strrep(force{1,1},',','.')).*area^-1; %Pa
repetition=xlsread('alpha_varying.xlsx',1,'G2');
nbrep=xlsread('alpha_varying.xlsx',1,'F2');
copy=nbrep+700;
...
xlwrite('alpha_varying.xlsx',max(stress11),1,'C2');
xlwrite('alpha_varying.xlsx',n,1,'D2');
p70=length(find(stress11(1:repetition)>70e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p70,1,'B3');
p90=length(find(stress11(1:repetition)>90e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p90,1,'C3');
p110=length(find(stress11(1:repetition)>110e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p110,1,'D3');
p130=length(find(stress11(1:repetition)>130e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p130,1,'E3');
p150=length(find(stress11(1:repetition)>150e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p150,1,'F3');
p170=length(find(stress11(1:repetition)>170e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p170,1,'G3');
p190=length(find(stress11(1:repetition)>190e6))/repetition;
xlwrite('/home/ma/b_b1.1_a0.1_lam0.1_alphafix/greater_stress_proportion.xlsx',p190,1,'H3');