...
grid on;
grid minor;
 hLegend=legend({'rear to front(X)','left to right(Y)','top to bottom(Z)'},'FontSize',30,'FontWeight','bold');
...
hXLabel =xlabel('number of recorded points with frenquency f=256(s^{-1})' ,'Fontsize' ,30,'FontWeight' , 'bold');
 hYLabel =ylabel('Force(N)', 'Fontsize' ,35,'FontWeight' , 'bold');
...
set(gcf, 'PaperPosition', [0 0 1080 600]); %set(gcf,'PaperPosition',[left,bottom,width,height])
 saveas(gcf,'F:\Git\Doctor_thesis_Zepeng\figures\xyz_suspension.png');
