...
n=1;       %initial recording point
  ...
  n
    figure(1);
    hold on;
DamageCha1=plot ((1:n),Dcha1(1:n), 'LineStyle', 'none','LineWidth', 1, 'Marker', 'o', 'MarkerSize', 8, ...
...
n
  hold on;
 Damagecyc=plot ((1:n),Dcyc(1:n),'LineStyle', 'none','LineWidth', 1, 'Marker', '^', 'MarkerSize', 8, ...
   'MarkerEdgeColor', [205 155 29]/255  , 'MarkerFaceColor' , [205 155 29]/255);
...
hold on;
DamageN_fixalp=plot ((1:n),D(1:n),'LineStyle', 'none','LineWidth', 1, 'Marker', 'v', 'MarkerSize',8, ...
...
hold on;
DamageN_varyingalp=plot ((1:n),D2(1:n),'LineStyle', 'none','LineWidth', 1, 'Marker', 's', 'MarkerSize',8, ...
    'MarkerEdgeColor',  [106 90 205]/255, 'MarkerFaceColor' ,  [106 90 205]/255);
grid on;
grid minor;
set(gca ,'FontSize',35);
...
hYLabel = ylabel('Damage', 'Fontsize' ,35);
 hLegend=legend([Damagecyc,DamageN_fixalp,DamageN_varyingalp,DamageCha1],'Analytical method with \alpha=0.78165','Numerical method with \alpha=0.78165',...
     'Numerical method with \alpha varying with stress','Chaboche method with \gamma=0.1','Location','northwest');
...
figure(3);
     hold on
Damagediff1=plot ((Dcyc(1:n-60)-D(1:n-60)).*Dcyc(1:n-60).^-1,'LineStyle', 'none','LineWidth', 1, 'Marker', 'o', 'MarkerSize', 6, ...
...
hXLabel = xlabel('Number of steps' ,'Fontsize' ,35);
hYLabel = ylabel('Relative difference', 'Fontsize' ,35);
% Adjust font
set(gca, 'FontName', 'Helvetica')
set([hTitle, hXLabel, hYLabel], 'FontName', 'AvantGarde')
% Adjust axes properties
