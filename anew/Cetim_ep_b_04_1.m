...
area=25.9695e-6; %meter square
stress11=1000*str2double(strrep(force{1,1},',','.')).*area^-1; %Pa
copy=2;
stress11=repmat(stress11,copy,1);
clear force;
...
hTitle =title('Stress evlolution of EP\_b\_04\_1 random load' ,'Fontsize' ,25);
...
saveas(gcf,'F:\Git\Anew\figures\ep_b_04_1stress.png');
...
% set(gca ,'FontSize',25);
% hXLabel = xlabel('t(s)' ,'Fontsize' ,25);
% hTitle =title('Damage evolution of EP\_b\_04\_1 random load' ,'Fontsize' ,25);
...
% set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
% set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
% saveas(gcf,'F:\Git\Anew\figures\ep_b_04_1damage.png');

xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',length(stress11)/copy,1,'B30');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n0,1,'C30');
xlswrite('F:\Git\MATLAB\anew\tuning.xlsx',n,1,'D30');
