...
hLegend=legend([alpcos_ben,alpcyc_ben,alpcos_tor,alpcyc_tor],...
    '\alpha in sinosoidal bending(\alpha_m=9.620)','\alpha in cyclic bending(\alpha_m=9.158)','\alpha in sinosoidal torsion(\alpha_m=7.625)','\alpha in cyclic torsion(\alpha_m=2.981)','Location','best');
