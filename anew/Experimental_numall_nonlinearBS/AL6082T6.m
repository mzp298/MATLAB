...
gam=300;       %recall term coeficient of backstress
lamplus_num=0.9; %manual numerical fit
save('AL6082T6.mat','W0','b','fb','delta_alp','a','lamplus_num','lamratio','lamplus','lamminus','E','k','nu','y','stepnumber','cycles','gam');
%------------torsion fit-------------------------
