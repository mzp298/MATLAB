...
[time,cycles,force,forcecommande,displacement]=textread('F:\Git\Cetim\ep_a_03\Acqui_CV.txt','%s%s%s%s%s','headerlines',5);
...
n0=254;                   %number of initial local defects
...
hTitle =title('Stress evlolution of Ep\_03 random load' ,'Fontsize' ,25);
...
saveas(gcf,'F:\Git\Anew\figures\ep03_stress.png');
...
set(gca ,'FontSize',25);
hXLabel = xlabel('t(s)' ,'Fontsize' ,25);
hTitle =title('Damage evolution of Ep\_03 random load' ,'Fontsize' ,25);
...
set(gcf, 'PaperUnits', 'points'); %[ {inches} | centimeters | normalized | points ]
set(gcf, 'PaperPosition', [0 0 1080 608]); %set(gcf,'PaperPosition',[left,bottom,width,height])
saveas(gcf,'F:\Git\Anew\figures\ep03_damage.png');
