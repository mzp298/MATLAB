...
run('Parameters_HNAP')
load('gaussian.mat');
fid = fopen('F:\Git\MATLAB\anew\m-file on Linux\HNAP_random\4icbmff1994Macharandomrawtimehistory.txt');
...
fclose(fid);
sig_xx_original=1e6.*f_sig_xx(1)*force{1,1};%Pa
tau_xy_original=1e6.*f_tau_xy(1)*force{1,1}; %Pa
